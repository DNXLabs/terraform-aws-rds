...
5. Follow all instructions in [the template](./.github/pull_request_template.md)
6. Follow the [styleguides](https://github.com/jonbrouse/terraform-style-guide/blob/master/README.md)
